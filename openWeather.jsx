  ...
  return(
    <Container>      
      ...
      <div className="search-bar">
        <input type="text"  onChange={(e) => setCity(e.target.value)} placeholder='Enter your city name'></input>
      ...
      {weather !== null ? (
        <div className="card-weather">
          ...
          <div className='weather'>
            ...
            <h6>Min: {Math.round(weather.main.temp_min - 273)}&deg;C ||
             Max: {Math.round(weather.main.temp_max - 273)}&deg;C || 
             Humidity: {Math.round(weather.main.humidity)}% </h6>            
          </div>
        </div>
      ) : null}       
    </Container>     
